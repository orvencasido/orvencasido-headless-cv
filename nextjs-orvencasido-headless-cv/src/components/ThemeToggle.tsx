...
export default function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="group relative p-2.5 rounded-full bg-muted/20 hover:bg-muted/40 transition-all duration-500 border border-border/50 hover:border-foreground/20"
            ...
            <div className="relative w-5 h-5 overflow-hidden">
                ...
                <svg
                    ...
                    className={`absolute inset-0 w-full h-full transition-all duration-500 transform ${
                        resolvedTheme === "dark" ? "translate-y-[120%] opacity-0 rotate-90" : "translate-y-0 opacity-100 rotate-0"
                    }`}
                >
                ...
                <svg
                    ...
                    strokeLinejoin="round"
                    className={`absolute inset-0 w-full h-full transition-all duration-500 transform ${
                        resolvedTheme === "dark" ? "translate-y-0 opacity-100 rotate-0" : "translate-y-[-120%] opacity-0 -rotate-90"
                    }`}
                >
